...
\begin{equation*}
\begin{aligned}[c]
    \overline{x} = \frac{1}{n} &\sum^{l}_{i=1} \overline{x}_i n_{i.} = {{ x_mean }} \\
    s^2_X = \frac{1}{n} &\sum^{l}_{i=1} \overline{x}_i^2 n_{i.} - {\overline{x}}^2 =
    \frac{1}{ {{ n }} } \cdot {{ x_means_squared_ni }} - {{ x_mean ** 2 }} =
    {{ x_variance }} \\
\end{aligned}
    \hspace{1em}
\begin{aligned}[c]
    \overline{y} = \frac{1}{n} &\sum^{m}_{k=1} \overline{y}_k n_{.k} = {{ y_mean }} \\
    s^2_Y = \frac{1}{n} &\sum^{m}_{k=1} \overline{y}_k^2 n_{.k} - {\overline{y}}^2 =
    \frac{1}{ {{ n }} } \cdot {{ y_means_squared_nk }} - {{ y_mean ** 2 }} =
    {{ y_variance }} \\
\end{aligned}
\end{equation*}
